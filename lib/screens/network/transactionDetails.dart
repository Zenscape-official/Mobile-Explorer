                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                    children:  <Widget>[
                      ...
                      Text('Status',
                          style:kSmallTextStyle),
                      const SizedBox(height: 2,),
                      Text(widget.txModel!.data!.code==0?'Success':'Fail',
                          style:kMediumBoldTextStyle),
                      const SizedBox(height: 20,),
                      Text('Height',
                          style:kSmallTextStyle),
                      ...
                      Text('Fee',
                          style:kSmallTextStyle),
                      const SizedBox(height: 2,),
                      Text(widget.txModel!.data!.tx!.authInfo!.fee!.amount![0].amount!+ ' '+widget.txModel!.data!.tx!.authInfo!.fee!.amount![0].denom!.toUpperCase(),
                      ...
                      Text('Gas (used/wanted)',
                          style:kSmallTextStyle),
                      const SizedBox(height: 2,),
                      Text(widget.txModel!.data!.gasUsed!+' / '+ widget.txModel!.data!.gasWanted!,
                          style:kMediumBoldTextStyle),
                      const SizedBox(height: 20,),
                      Text('Memo',
                          style:kSmallTextStyle),
