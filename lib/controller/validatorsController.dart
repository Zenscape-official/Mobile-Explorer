...
import 'package:zenscape_app/backend_files/atomValidatorModel.dart';
  ...
  Future<dynamic> fetchAtomVal(String ApiUri) async {
    ...
    try {
      ...
      switch (response.statusCode) {
        case 200:
        case 201:
          var jsonString = jsonDecode(response.body)['validators'];
          validatorsList =List.from(jsonString.map((x) => Validator.fromJson(x))).obs;
